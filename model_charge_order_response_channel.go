...
type _ChargeOrderResponseChannel ChargeOrderResponseChannel
...
func (o *ChargeOrderResponseChannel) UnmarshalJSON(data []byte) (err error) {
	varChargeOrderResponseChannel := _ChargeOrderResponseChannel{}

	err = json.Unmarshal(data, &varChargeOrderResponseChannel)

	if err != nil {
		return err
	}

	*o = ChargeOrderResponseChannel(varChargeOrderResponseChannel)
